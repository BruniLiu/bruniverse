        ...
        >
          ...
          <div className="mx-auto grid w-full max-w-7xl flex-1 items-center gap-8 py-6 sm:py-10 lg:grid-cols-[minmax(0,0.95fr)_minmax(360px,0.72fr)] lg:gap-10 lg:py-8">
            ...
            >
              ...
              <div className="mx-auto grid w-full max-w-[640px] gap-2 rounded-lg border border-white/10 bg-white/[0.04] px-4 py-3 text-left shadow-[0_14px_44px_rgba(0,0,0,0.16)] backdrop-blur lg:mx-0">
                <div className="flex flex-wrap items-center gap-2">
                  <span className="rounded-full border border-sky-100/18 bg-sky-100/[0.08] px-2.5 py-1 text-[10px] font-bold uppercase tracking-[0.12em] text-sky-100/76">
                    Group 28
                  </span>
                ...
                <div className="flex flex-wrap gap-1.5">
                  {teamMembers.map((member) => (
                    <span
                      key={member.name}
                      className="rounded-full border border-white/[0.08] bg-black/16 px-2.5 py-1 text-[11px] font-semibold text-white/56"
                    >
                      <span className="text-white/76">{member.englishName}</span>
